...
#
# 1. Simulate (`load_and_sample_petri_model`)
# 2. Calibrate-Simulate (`load_and_calibrate_and_sample_petri_model`)
# 3. Optimize-Simulate (`load_and_optimize_and_sample_petri_model`)
# 4. Calibrate-Optimize-Simulate (`load_and_calibrate_and_optimize_and_sample_petri_model`)
